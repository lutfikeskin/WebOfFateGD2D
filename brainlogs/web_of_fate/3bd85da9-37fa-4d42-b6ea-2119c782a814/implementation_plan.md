...
- Extends `Resource`.
- Exports: `id`, `display_name`, `type`, `tags`, `base_chance`, `legacy_gain`, `chaos_gain`, `multiplier`, `chaos_multiplier`, `upgrade_paths`, `special_effect`.
...
- Extends `Resource`.
- Exports: `id`, `required_tags`, `positions`, `sequence`, `legacy_multiplier`, `legacy_bonus`, `chaos_bonus`, `description`.
